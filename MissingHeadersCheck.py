...
from javax.swing import (JPanel, JTextArea, JButton, JScrollPane,
                         Box, JLabel, JSplitPane, JEditorPane)
...
class BurpExtender(IBurpExtender, ITab):
    ...
    def registerExtenderCallbacks(self, callbacks):
        ...
        # Disable report/details buttons until scan is run
    ...
    def scan_urls(self):
        ...
        for original_url_str in all_urls:
            ...
            current_url_str = original_url_str
            response_to_analyze = None
            final_url_for_analysis = current_url_str
            header_details = {} # Store (Status, Value)
            ...
            try:
                ...
                if not response_to_analyze:
                    results_summary.append((original_url_str, final_url_for_analysis, "Error: Too many redirects", {}, None))
                    continue
                ...
                example_data = None
                if not first_example_data and missing:
                    example_data = {
                    ...
                    first_example_data = example_data # Flag to stop searching
    ...
    def finish_scan_ui(self):
        ...
        if self._last_scan_results:
            ...
            self._results_output.setText("<html><body>Scan complete. Click 'Report' or 'Show Details' to view results.</body></html>")
        else:
    ...
    def generate_details_html(self, results):
        ...
        for orig_url, final_url, missing_list, header_details, example_data in results:
            ...
            report_html.append("</table>")
            report_html.append("<br>") # Add space between tables
